...
The model is trained using Mean Squared Error (MSE) loss between the predicted and true density matrices.

Although fidelity-based loss can be used, MSE provides stable training for small-dimensional systems.
